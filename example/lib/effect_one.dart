...
//  audio_visualizer
//
//  Created by shang on 2025/3/6 14:34.
...
class EffectOne extends StatefulWidget {
  const EffectOne({
    super.key,
    this.arguments,
  });
  ...
  @override
  State<EffectOne> createState() => _EffectOneState();
}

class _EffectOneState extends State<EffectOne> {
        ...
        children: [
          ...
          Padding(
            ...
            child: ListenableBuilder(
              ...
              builder: (context, child) {
                return Text(
                  audioPlayer.value.status == PlayerStatus.playing ? "Now Playing" : "",
